...
class CostDetailView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        buildLabel(labelFrame: CGRect(x:100, y:35, width:ScreenWidth - 110, height:20), text: "$" + UserShopCarTool.sharedUserShopCar.getAllProductsPrice(), font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:60, width:ScreenWidth - 110, height:20), text: "$" + distribution!, font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:85, width:ScreenWidth - 110, height:20), text: "$0", font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
        ...
        buildLabel(labelFrame: CGRect(x:100, y:110, width:ScreenWidth - 110, height:20), text: "$" + coupon!, font: UIFont.systemFont(ofSize: 14), textColor: UIColor.black, textAlignment: NSTextAlignment.right)
